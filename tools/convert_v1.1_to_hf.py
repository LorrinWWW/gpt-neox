...
def convert(input_checkpoint_path, loaded_config, output_checkpoint_path):
    ...
    # hf_config = GPTNeoXConfig.from_pretrained('EleutherAI/pythia-6.9b-deduped')
    # hf_config.rotary_pct = 1.0
...
if __name__ == "__main__":
    ...
    loaded_config['tokenizer-type'] = "HFTokenizer" # hack
